          ...
          <v-col cols="12" md="8" class="text-center">
            ...
            <v-container class="select-container">
              ...
              " md="4">
                ...
                <v-col cols="12">
                  <v-text-field v-model="address" label="搜尋地址" placeholder="請輸入地址" @keyup.enter="handleSubmit"
                                @click="handleReset" outlined></v-text-field>
                </v-col>
                <v-col cols="12" md="3">
  ...
  methods: {
    ...
    next (page) {
      if (this.page.index < 1) {
        console.error('index錯誤')
        return
      }
      this.queryParams.offset = (this.page.index - 1) * 9
      this.queryParams.limit = 9
      this.queryParams = Object.assign({}, this.$options.data().queryParams, this.queryParams)
      this.getHouseList(page)
      console.log('pagehouse', this.getHouseList(page))
      window.scrollTo({
        top: 550,
        behavior: 'smooth'
      })
